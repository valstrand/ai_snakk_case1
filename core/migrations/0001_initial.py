# Generated by Django 5.0.7 on 2025-10-01 15:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('brand_name', models.CharField(default='AI-Snakk', max_length=100)),
                ('logo_image', models.ImageField(blank=True, null=True, upload_to='site/')),
                ...
                ('newsletter_provider', models.CharField(blank=True, help_text='Newsletter service provider', max_length=100)),
                ('analytics_id', models.CharField(blank=True, help_text='Google Analytics or Plausible ID', max_length=50)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('seo_title', models.CharField(blank=True, help_text='SEO title (max 60 chars)', max_length=60)),
                ('seo_description', models.TextField(blank=True, help_text='SEO description (max 160 chars)', max_length=160)),
                ('is_published', models.BooleanField(default=False, help_text='Check to publish this content')),
                ('publish_at', models.DateTimeField(blank=True, help_text='Schedule publication date/time', null=True)),
                ('title', models.CharField(max_length=200)),
                ('slug', models.SlugField(blank=True, max_length=200, unique=True)),
                ('client', models.CharField(blank=True, help_text='Client or company name', max_length=100)),
                ('industry', models.CharField(blank=True, max_length=100)),
                ('summary', models.TextField(help_text='Brief description of the case study', max_length=300)),
                ('body', django_ckeditor_5.fields.CKEditor5Field(verbose_name='default')),
                ('cover_image', models.ImageField(blank=True, null=True, upload_to='cases/')),
                ('featured', models.BooleanField(default=False, help_text='Feature this case study on homepage')),
                ('roi_percentage', models.PositiveIntegerField(blank=True, help_text='ROI percentage', null=True)),
                ('cost_savings', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
                ('time_savings', models.CharField(blank=True, help_text="e.g., '50% reduction in processing time'", max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=200)),
                ('slug', models.SlugField(blank=True, max_length=200, unique=True)),
                ('summary', models.TextField(help_text='Brief description of the post', max_length=300)),
                ('body', django_ckeditor_5.fields.CKEditor5Field(verbose_name='default')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=200)),
                ('slug', models.SlugField(blank=True, max_length=200, unique=True)),
                ('speaker', models.CharField(help_text='Speaker name', max_length=100)),
                ('speaker_title', models.CharField(blank=True, help_text='Speaker title/role', max_length=200)),
                ('speaker_bio', models.TextField(blank=True)),
                ('summary', models.TextField(help_text='Brief description of the presentation', max_length=300)),
                ('body', django_ckeditor_5.fields.CKEditor5Field(blank=True, help_text='Full presentation description/notes', verbose_name='default')),
                ...
                ('featured', models.BooleanField(default=False, help_text='Feature this presentation on homepage')),
                ('presentation_date', models.DateField(blank=True, null=True)),
                ('event', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='presentations', to='core.event')),
                ('tags', taggit.managers.TaggableManager(blank=True, help_text='A comma-separated list of tags.', through='taggit.TaggedItem', to='taggit.Tag', verbose_name='Tags')),
            ],
            options={
